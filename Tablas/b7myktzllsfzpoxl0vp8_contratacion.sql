...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'f41d366d-91e5-11e9-8525-cecd028ee826:1-138974525';
...
CREATE TABLE `contratacion` (
  ...
  CONSTRAINT `contratacion_ibfk_1` FOREIGN KEY (`vacante_id`) REFERENCES `vacante` (`id`) ON DELETE CASCADE,
  CONSTRAINT `contratacion_ibfk_2` FOREIGN KEY (`coder_id`) REFERENCES `coder` (`id`) ON DELETE CASCADE
...
INSERT INTO `contratacion` VALUES (1,2,1,'2024-04-09 17:37:21','hola',10.00);
...
-- Dump completed on 2024-04-09 13:58:07
